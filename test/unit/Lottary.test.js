...
//   : 
  describe("Raffle Unit Tests", function () {
      ...
      beforeEach(async () => {
        ...
        vrfCoordinatorV2Mock = await ethers.getContractFactory("VRFCoordinatorV2Mock"); // Returns a new connection to the VRFCoordinatorV2Mock contract
        raffleContract = await ethers.getContractFactory("Lottary"); // Returns a new connection to the Raffle contract
